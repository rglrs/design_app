...
export default function AdminPage() {
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 max-w-6xl mx-auto space-y-8 md:space-y-12">
      <Toaster position="top-center" richColors />
      
      <div>
        <h1 className="text-2xl md:text-3xl font-bold tracking-tight">Manajemen Desain</h1>
        <p className="text-zinc-500 mt-1">Kelola katalog aset visual yang akan ditampilkan di website utama.</p>
      </div>
